	...
	function init()
	{
		...
		({
			...
			[[
				...
				{field:'infoerVisitAmount', title:'信息员回访数', width: 3},
				{field:'talkingVistiAmount', title:'在谈单回访数', width: 3},
				{field:'infoerAddAmount', title:'信息员录入数', width: 3},
				{field:'infoerTracingTotal', title:'正跟踪信息员总数', width: 3},
				{field:'clientAddAmount', title:'客户录入数', width: 3},
				{field:'contactingClinetTotal', title:'联系中的客户总数', width: 3},
				{field:'talkingAmount', title:'在谈单数', width: 3},
				{field:'dealTotal', title:'已签单数', width: 3},
				{field:'monthTalkingAmount', title:'本月提单数量', width: 3}
			]],
			border: false,
			pagination: true,
			singleSelect: true,
