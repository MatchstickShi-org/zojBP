...
<div class="easyui-layout" data-options="fit:true" style="margin: 2px;">
	<div data-options="region:'center'" style="width: 470px;">
		...
		<div id="orderCheckDatagridToolbar">
			...
			<input style="width:100px;" class="easyui-textbox" id="orderApprove-nameInput"/>
			...
			<label><input type="checkbox" value="20" name="orderStatusInput" />打回申请</label>
	...
	<div data-options="region:'south', split:true, border: true" style="height: 270px;">
		<div id="clientMgrTab" data-options="tools:'#clientMgrTab-tools'">
			<div title="详情">
				<form id="editOrderForm" action="marketing/clientCheckMgr/editOrder" method="post" style="width: 100%;">
...
<script type="text/javascript" src="pages/design/clientCheck/index.js"></script>
</body>
</html>