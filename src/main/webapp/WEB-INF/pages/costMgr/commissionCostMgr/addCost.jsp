	...
	<table style="width: 100%">
		...
		<tr>
			<td align="center" colspan="4">
				<a class="easyui-linkbutton" id="commissionMgr-addBtn" iconCls="icon-ok" href="javascript:void(0)">新增</a>
...
var $showAddCommissionCostWindow = $('div#commissionMgr-addCostWindow');
...
<c:if test="${requestScope.errorMsg == null}">
	<script type="text/javascript" src="pages/costMgr/commissionCostMgr/addCost.js"></script>
</c:if>
</body>
</html>