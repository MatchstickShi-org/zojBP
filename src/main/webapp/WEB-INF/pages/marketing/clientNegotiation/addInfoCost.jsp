	...
	<table style="width: 100%">
		...
		<tr>
			<td align="center" colspan="4">
				<a class="easyui-linkbutton" id="addInfoCostRecordBtn" iconCls="icon-ok" href="javascript:void(0)">新增</a>
...
<c:if test="${requestScope.errorMsg == null}">
	<script type="text/javascript" src="pages/marketing/clientNegotiation/addInfoCost.js"></script>
</c:if>
</body>
</html>