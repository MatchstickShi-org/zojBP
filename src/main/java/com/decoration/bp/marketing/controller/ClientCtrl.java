 ...
 * 
 */
package com.decoration.bp.marketing.controller;
...
import com.decoration.bp.costmgr.infocostmgr.service.IInfoCostMgrService;
import com.decoration.bp.marketing.service.ICommissionCostService;
import com.decoration.bp.marketing.service.IInfoCostService;
import com.decoration.bp.marketing.service.IInfoerService;
...
public class ClientCtrl
{
	...
	public ModelAndView showAddInfoCostWindow(HttpSession session, @RequestParam(value="orderId") Integer orderId)
	{
		...
		com.decoration.bp.costmgr.infocostmgr.vo.InfoCost infoCost = infoCostMgrSvc.getInfoCostByOrder(orderId);
